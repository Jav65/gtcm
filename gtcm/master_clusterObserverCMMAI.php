...
<body>
  <div style="max-width: 1980px; margin: auto; ">
    ...
    <div class="container">
      ...
      $sqlCluster = "SELECT id FROM tb_cluster";
          ...
          <div class="grid-1">
            ...
            if ($result->num_rows > 0) {
              ...
              while ($row = $result->fetch_assoc()) {
                ...
                echo "<td><a href=\"programObserverCMMAI.php?id_cluster=$id_cluster\"> $programCount</a></td>";
                echo "<td><a href=\"indikatorObserverCMMAI.php?id_cluster=$id_cluster\"> $indikatorCount</a></td>";
                echo "<td><a href=\"kegiatanObserverCMMAI.php?id_cluster=$id_cluster\"> $kegiatanCount</a></td>";
                echo "</tr>";
              }
              echo "</tbody>";
              echo "</table>";
