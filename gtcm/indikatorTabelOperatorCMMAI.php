    ...
    <div style="max-width: 1980px; height: 100%; margin: auto; background-color: rgb(194, 187, 187);">
        ...
        <div class="grid-container">
            <div class="item2">
                ...
                <form action="indikatorTabelOperatorCMMAI.php" id="indikatorFilter" style="display: inline-block;"
                    method="get">
                    <div>
                ...
                <script>
                    function filterData(type) {
                        if (type == "cluster") {
                            ...
                            urlFilter = `indikatorTabelOperatorCMMAI.php?id_cluster=${filterValue}`;
                        } else {
                            urlFilter = "";
                        }
                        ...
                        foreach ($clusterDashboard as $id_cluster) {
                            ...
                            foreach ($id_programList as $id_program) {
                                ...
                                if ($resultSqlIndikator->num_rows > 0) {
                                    ...
                                    while ($indikatorInfo = $resultSqlIndikator->fetch_assoc()) {
                                        ...
                                        foreach ($indikatorInfo as $colName => $indikatorValue) {
                                            if ($indexIndikator == 2) {
                                                echo "    <td onClick=\"location.href='kegiatanTabelOperatorCMMAI.php?id_indikator=$id_indikator'\"
                            ...
                            if ($indexProgram == 0) {
                                if ($otherInstansiBool == 0) {
                                    echo "Instansi-instansi yang dipilih belum memiliki program yang di filter";
                                } else {
                                    echo "0 data";
                                }
                            }
