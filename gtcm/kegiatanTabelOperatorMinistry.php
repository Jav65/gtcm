  ...
  <div style="max-width: 1980px; margin: auto">
    ...
    <div class="grid-container">
      <div class="item2">
        ...
        <form action="kegiatanTabelOperatorMinistry.php" id="kegiatanFilter" style="display: inline-block;"
          method="get">
          <div>
        ...
        <script>
          function filterData(type) {
            if (type == "cluster") {
              ...
              urlFilter = `kegiatanTabelOperatorMinistry.php?id_cluster=${filterValue}`;
            } else if (type == "program") {
              filterValue1 = document.getElementById("id_cluster").value;
              filterValue2 = document.getElementById("id_program").value;
              urlFilter = `kegiatanTabelOperatorMinistry.php?id_cluster=${filterValue1}&id_program=${filterValue2}`;
            } else {
              urlFilter = "";
            }
