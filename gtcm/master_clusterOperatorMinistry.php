          ...
          <div class="grid-1">
            ...
            if ($result->num_rows > 0) {
              ...
              while ($row = $result->fetch_assoc()) {
                ...
                echo "<td><a href=\"programTabelOperatorMinistry.php?id_cluster=$id_cluster\"> $programCount</a></td>";
                echo "<td><a href=\"indikatorTabelOperatorMinistry.php?id_cluster=$id_cluster\"> $indikatorCount</a></td>";
                echo "<td><a href=\"kegiatanTabelOperatorMinistry.php?id_cluster=$id_cluster\"> $kegiatanCount</a></td>";
                echo "</tr>";
              }
              echo "</tbody>";
              echo "</table>";
