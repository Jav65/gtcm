...
<body>
  ...
  <button class="button2" style="color: #00008B;" onclick="submitFormProgramPage()">Daftar Program </button>
        ...
        <form action="programTabelOperatorCMMAI.php" id="programFilter" style="display: inline-block;" method="get">
          <div>
              ...
              foreach ($idTbProgram as $id_program) {
                ...
                foreach ($rowTbProgram as $key => $colName) {
                  if ($indexProgram == 3) {
                    echo "<td>";
                    echo "<div>";
                    echo "  <a href=\"indikatorTabelOperatorCMMAI.php?id_program=$id_program\"
                    ...
                    echo "  </a>";
                    echo "  <a href=\"kegiatanTabelOperatorCMMAI.php?id_program=$id_program\"
                            onmouseover=\"this.style.backgroundColor='#90EE90'; \"
                            onmouseout=\"this.style.backgroundColor='white'; \">";
                    // echo "    <td style='cursor: pointer;'
                    //             onmouseover=\"this.style.backgroundColor='#90EE90'; \"
