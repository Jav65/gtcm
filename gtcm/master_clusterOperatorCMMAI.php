          ...
          <div class="grid-1">
            ...
            if ($result->num_rows > 0) {
              ...
              while ($row = $result->fetch_assoc()) {
                ...
                $program = "<p class='text-center'><a href='programTabelOperatorCMMAI.php?id_cluster=$id_cluster&deskripsi=$deskripsi'><i class='fa fa-eye'></i></a></p>";
                ...
                echo "<td><a href=\"programTabelOperatorCMMAI.php?id_cluster=$id_cluster\"> $programCount</a></td>";
                echo "<td><a href=\"indikatorTabelOperatorCMMAI.php?id_cluster=$id_cluster\"> $indikatorCount</a></td>";
                echo "<td><a href=\"kegiatanTabelOperatorCMMAI.php?id_cluster=$id_cluster\"> $kegiatanCount</a></td>";
                echo "</tr>";
              }
              echo "</tbody>";
              echo "</table>";
