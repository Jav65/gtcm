...
<body>
    ...
    <div style="max-width: 1980px; margin: auto; ">
        ...
        <div style="padding:20px;">
            ...
            <form action="dashboardMainMinistry.php" id="dashboardFilter" style="display: inline-block;" method="get">
                <div>
                    ...
                    <div class='card' onclick="submitFormMainPage('')" style='cursor:pointer; padding:15px;'
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 float-right">
                                <a href="programTabelObserverMinistry.php"><u>View Detail</u></a>
                            </div>
                        </div>
                    ...
                    <div class="card" style="overflow-y:auto;">
                        <div>
                            <ul class="nav tabs-admin" role="tablist" style="margin-bottom:5px;">
                                <li role="presentation" class="nav-item"><a class="nav-link active" href="kegiatanTabelObserverMinistry.php"
                ...
                <div>
                    <div class='card' onclick="submitFormMainPage('')" style='cursor:pointer; padding:15px;'
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 float-right">
                                <a href="problemTabelObserverMinistry.php"><u>View Detail</u></a>
                            </div>
                        </div>
                        <?php
                        if (isset($_GET['id_cluster'])) {
                ...
                <div>
                    <div class="card" style="padding: 15px;">
                        <div class="row">
                            ...
                            <div class="col-md-6 float-right">
                                <a href="lateTabelObserverMinistry.php"><u>View Detail</u></a>
                            </div>
                        </div>
