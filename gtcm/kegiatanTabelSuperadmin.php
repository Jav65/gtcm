  ...
  <div style="max-width: 1980px; margin: auto">
    ...
    <div class="grid-container">
      <div class="item2">
        ...
        <form action="kegiatanTabelSuperadmin.php" id="kegiatanFilter" style="display: inline-block;" method="get">
          <div>
        ...
        <script>
          function filterData(type) {
            if (type == "cluster") {
              ...
              urlFilter = `kegiatanTabelSuperadmin.php?id_cluster=${filterValue}`;
            } else if (type == "program") {
              filterValue1 = document.getElementById("id_cluster").value;
              filterValue2 = document.getElementById("id_program").value;
              urlFilter = `kegiatanTabelSuperadmin.php?id_cluster=${filterValue1}&id_program=${filterValue2}`;
            } else {
              urlFilter = "";
            }
              ...
              foreach ($id_programList as $id_program) {
                ...
                foreach ($id_indikatorList as $id_indikator) {
                  ...
                  echo " <button style='background-color: green; order-color: rgb(68, 151, 68); color: white; 
                          border-radius:3px' onclick=\"window.location.href='addKegiatan.php?id_indikator=$id_indikator'\">
                          + Add Kegiatan
                        </button>";
                  echo "</div>";
