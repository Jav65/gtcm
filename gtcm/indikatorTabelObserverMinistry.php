    ...
    <div style="max-width: 1980px; height: 100%; margin: auto; background-color: rgb(194, 187, 187);">
        ...
        <div class="grid-container">
            <div class="item2">
                ...
                <form action="indikatorTabelObserverMinistry.php" id="indikatorFilter" style="display: inline-block;"
                    method="get">
                    <div>
                ...
                <script>
                    function filterData(type) {
                        if (type == "cluster") {
                            ...
                            urlFilter = `indikatorTabelObserverMinistry.php?id_cluster=${filterValue}`;
                        } else {
                            urlFilter = "";
                        }
                            ...
                            foreach ($id_programList as $id_program) {
                                ...
                                if ($resultSqlIndikator->num_rows > 0) {
                                    ...
                                    while ($indikatorInfo = $resultSqlIndikator->fetch_assoc()) {
                                        ...
                                        foreach ($indikatorInfo as $colName => $indikatorValue) {
                                            if ($indexIndikator == 2) {
                                                echo "    <td onClick=\"location.href='kegiatanTabelObserverMinistry.php?id_indikator=$id_indikator'\"
