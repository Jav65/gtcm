...
<body>
    <div style="max-width: 1980px; margin: auto">
        <div>
            ...
            include "function/findParentFromId.php";
            ?>
        </div>
        <div>
            <?php
                ...
                <h2>Add Program</h1>
                    ...
                    <div class="container">
                        <form action="./selectName.php" method="post">
                            ...
                            <?php
                            $id_ministry = explode("_", $pic)[0];
                            $resultMinistry = parentFromId($id_ministry, "tb_master_kementrian");
                            $ministry = $resultMinistry['kementrian'];
                            ...
                            if ($pic == "MI-1_SP-") {
                                ...
                                $role = "Observer CMMAI";
                            } else if ($userInfo[1] == "OP-") {
                                $role = "Operator Ministry";
                            } else if ($userInfo[1] == "OB-") {
                                $role = "Observer Ministry";
                            }
                            echo "<h4>" . $ministry . " (" . $role . ")</h4>";

                            ?>

                            <div class="row">
                                <?php 
                                $filterUser = array("id_kementrian" => "$id_ministry");
                                $userList = idListTable("tb_master_pic", $filterUser);
                                foreach($userList as $id_pic){
                                    $picInfo = parentFromId($id_pic,"tb_master_pic");
                                    $name = $picInfo['nama_pic'];
                                    $labelName = str_replace(" ", "_", $name);
                                    echo '<input type="radio" id="' . $labelName .'" name="nama_pic" value="' . $name.'">';
                                    echo '<label for="'. $labelName.'">'.$name .'</label><br>';
                                }
                                ?>
                            </div>
