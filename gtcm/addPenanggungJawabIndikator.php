    ...
    <div style="max-width: 1980px; margin: auto">
        ...
        <div>
            ...
            if (isset($_POST['submit'])) {
                ...
                if ($conn->multi_query($sqlAddPenanggungJawab) === TRUE) {
                    // please edit
                    echo "succeed";
                    $indikatorInfo = parentFromId($id_div, "tb_indikator");
                    $penanggung_jawab_info = $indikatorInfo['penanggung_jawab_info'];

                    $penanggung_jawab_info++;

                    $sqlUpdateIndikator = "UPDATE tb_indikator SET penanggung_jawab_info = '$penanggung_jawab_info' WHERE id='$id_div'";
                    if ($conn->query($sqlUpdateIndikator) === TRUE) {
                        $link = "location:addPenanggungJawabIndikator.php?id_div=$id_div";
                        header($link);
                    }
                }
        ...
        <div id="main">
            ...
            <div id="right" class="text-black">
                ...
                echo "<h4>Indikator: $indikator</h4>";
                ?>
                ...
                <div class="container">
                    ...
                    if ($resultPenanggungJawab->num_rows > 0) {
                        ...
                        echo "  <input type='hidden' id='divName' name='divName' value='indikator'>";
                        echo "</form>";
                        echo "<script>";
                    ...
                    ?>
                    <form id="addPenannggungJawab" action="./addPenanggungJawabIndikator.php" method="post">
