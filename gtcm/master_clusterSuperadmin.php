        ...
        <div class="container-fluid mt-3">
          <div class="grid-1">
            ...
            echo "  <button
                      ...
                      onclick=\"window.location.href='addClusterSuperadmin.php'\" ;>
                      + add
                    </button>";
            echo "  <button id='myBtn_dashboard'>Filter</button>";
            echo "</div>";
            ...
            if ($result->num_rows > 0) {
              ...
              while ($row = $result->fetch_assoc()) {
                ...
                $update_link = "<p class='text-center'><a href='updateClusterSuperadmin.php?id_cluster=$id_cluster'><i class='fa fa-pencil' text-warning></i></a></p>";
                //$delete_link = "<p class='text-center'><a href='delete_program.php?id_program=$id'><i class='fa-solid fa-trash text-danger'></i></a></p>";
                $program = "<p class='text-center'><a href='programTabelSuperadmin.php?id_cluster=$id_cluster&deskripsi=$deskripsi'><i class='fa fa-eye'></i></a></p>";
                ...
                echo "<tr>";
                echo "<td>";
                echo "  <button type='button' onclick=\"window.location.href='updateClusterSuperadmin.php?id_cluster=$id_cluster'\"
                                            class='btn btn-primary' style='margin: 5px 0 3px 0'>Update</button>";
                echo "  <button type='button' onclick=\"window.location.href='delete_clusterSuperadmin.php?id_cluster=$id_cluster'\"
                ...
                echo "<td><a href=\"programTabelSuperadmin.php?id_cluster=$id_cluster\"> $programCount</a></td>";
                echo "<td><a href=\"indikatorTabelSuperadmin.php?id_cluster=$id_cluster\"> $indikatorCount</a></td>";
                echo "<td><a href=\"kegiatanTabelSuperadmin.php?id_cluster=$id_cluster\"> $kegiatanCount</a></td>";
                echo "</tr>";
              }
              echo "</tbody>";
              echo "</table>";
