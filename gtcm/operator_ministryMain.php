...
<body>
    ...
    <div style="max-width: 1980px; margin: auto; ">
        ...
        <div style="padding:20px;">
            ...
            <form action="operator_ministryMain.php" id="dashboardFilter" style="display: inline-block;" method="get">
                <div>
                    ...
                    <div class='card' onclick="submitFormMainPage('')" style='cursor:pointer; padding:15px;'
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 float-right">
                                <a href="programTabelOperatorMinistry.php"><u>View Detail</u></a>
                            </div>
                        </div>
                            ...
                            <script>
                                ...
                                var chartOptions = {
                                    ...
                                    scales: {
                                        xAxes: [{
                                            type: 'category',
                                            labels: ['Capaian B04', 'Capaian B06', 'Capaian B09', 'Capaian B12'],
                                            ticks: {
                                                autoSkip: false,
                                                maxRotation: 90,
                                                minRotation: 90,
                    ...
                    <div class="card" style="overflow-y:auto;">
                        <div>
                            <ul class="nav tabs-admin" role="tablist" style="margin-bottom:5px;">
                                <li role="presentation" class="nav-item"><a class="nav-link active" href="kegiatanTabelOperatorMinistry.php"
                ...
                <div>
                    <div class='card' onclick="submitFormMainPage('')" style='cursor:pointer; padding:15px;'
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 float-right">
                                <a href="problemTabelOperatorMinistry.php"><u>View Detail</u></a>
                            </div>
                        </div>
                        <?php
                        if (isset($_GET['id_cluster'])) {
                        ...
                        $arrayInstansiMasing = array();
                        $arrayInstansiMasing[] = $userMinistry;
                ...
                <div>
                    <div class="card" style="padding: 15px;">
                        <div class="row">
                            ...
                            <div class="col-md-6 float-right">
                                <a href="lateTabelOperatorMinistry.php"><u>View Detail</u></a>
                            </div>
                        </div>
